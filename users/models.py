...
class CustomUser(AbstractBaseUser, PermissionsMixin):
  ...
  discount_ratio = models.DecimalField(max_digits=4, decimal_places=2, default=0, verbose_name='Discount', help_text='Must be a number from 0.00 to 1.00 (up to 2 decimal places)')
