    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_ratio', models.DecimalField(decimal_places=2, default=0, help_text='Must be a number from 0.00 to 1.00 (up to 2 decimal places)', max_digits=4, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1)], verbose_name='Discount')),
